...
Bumpup the current population  of all the countries by 1L - Map 
...
let asianCountries = restcountries.filter((countries) => {
  return countries.region === "Asia";
});

console.log(asianCountries.length);

let smallCountries = restcountries.filter((countries) => {
  return countries.population <= 200000;
});

console.log(smallCountries);

let increasePopulation = restcountries.map(
  (countries) => countries.population + 100000
);

console.log(increasePopulation);

let upperCaseNames = restcountries.map((countries) =>
  countries.name.toUpperCase()
);

console.log(upperCaseNames);

let rest = restcountries.forEach((countries) => {
...
let worldPopulation = restcountries.reduce((total, countries) => {
  return countries.population + total;
}, 0);

console.log(worldPopulation);

let totalPopulationAsia = asianCountries.reduce((total, countries) => {
  return countries.population + total;
}, 0);

console.log(totalPopulationAsia);
